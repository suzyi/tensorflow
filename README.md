...
+ **Download [CUDA Toolkit](https://developer.nvidia.com/cuda-downloads) & [cuDNN](https://developer.nvidia.com/cudnn)**. CUDA Toolkit package has around 1.4GB, and cuDNN has about three files around 200MB need to be downloaded. By the way, you need register first and answer a questionaire before you are allowed to aquire cuDNN package.
